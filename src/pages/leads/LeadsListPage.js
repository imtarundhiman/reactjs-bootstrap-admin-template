    ...
    render(){
        return <>
            <div className="table-container lead-list">
                <div className="row">
                    <div className="col">
                        <h5 className="pb-2 mb-0">Leads</h5>
                    </div>
                </div>
                <p>
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="source">Website</td>
                                ...
                                <td>
                                    <div className="dropdown table-action-dropdown">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButtonSM">
                                            <li><a className="dropdown-item" href="#"><i className="fa fa-eye" aria-hidden="true"></i>&nbsp;Details</a></li>
                            ...
                            <tr>
                                ...
                                <td className="source">Relationship Manager</td>
                            ...
                            <tr>
                                ...
                                <td className="source">Email Marketing</td>
...
export default adminLayout(LeadListPage);